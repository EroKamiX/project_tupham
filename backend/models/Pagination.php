...
class Pagination
{
    public $params = [
        ...
        'query_additional' => '' //chứa chuỗi query từ url nếu có, ví dụ như khi search theo name, thì biến này sẽ có giá trị là &name=abc chẳng hạn, để đảm bảo phân trang hoạt động đúng khi có thêm các query từ trình duyệt
    ];
    ...
    public function getPrevPage()
    {
        ...
        if ($this->getCurrentPage() > 1) {
            ...
            $prev_page = '<li class="page-item"><a href="' . $prev_link . '">Prev</a></li>';
        }
    ...
    public function getNextPage()
    {
        ...
        if ($this->getCurrentPage() < $this->getTotalPage()) {
            ...
            $next_page = '<li class="page-item"><a href="' . $next_link . '">Next</a></li>';
        }
    ...
    public function getPagination()
    {
        ...
        for ($i = 1; $i <= $this->getTotalPage(); $i++) {
            if ($i == $this->getCurrentPage()) {
                $data .= "<li class='active page-item'><a href=''>$i</a></li>";
            } else {
                $link_current = $this->full_url . $i;
                $data .= "<li class='page-item'><a href='$link_current'>$i</a></li>";
            }
        }
