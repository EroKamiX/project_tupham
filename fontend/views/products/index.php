    ...
    <div class="container">
        <ul class="nav justify-content-center">
            <?php foreach ($products AS $product): ?>
                <li class="nav-item" style="width: 273px; display: inline-block">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img class="" src="../backend/assets/uploads/<?php echo $product['avatar'] ?>" alt="">
                        </div>
                        <h2 class="summary" style="height: 50px"><a
                                    href="index.php?controller=product&action=detail&id=<?php echo $product['id'] ?>"><?php echo $product['title'] ?></a>
                        </h2>
